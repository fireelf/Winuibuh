...
namespace BuhLib
{
    public enum MoneyType {plus, minus};
    ...
    public class MoneyFlowUnit
    {
        ...
        public string Account { get { return _Account_Id; } }
        public string Comment { get { return _Comment; } }
        public string Summ { get { return _Count.ToString(); } }

        private string _Account_Id {get; set;}    // cчет
        ...
        public MoneyFlowUnit(string AccID, double Count, int CategoryID, string UserComment, DateTime Date)
        {
            _Account_Id = AccID;
            _Count = Count;
        ...
        public MoneyFlowUnit(string AccID, double Count, int CategoryID, string UserComment, DateTime Date, MoneyType type)
        {
            _Account_Id = AccID;
            _Count = Count;
            _Category = CategoryID;
        ...
        public void Change(string AccID, double Count, int CategoryID, string UserComment, DateTime Date)
        {
            if (AccID != null)
                _Account_Id = AccID;
            if (Count != null)
